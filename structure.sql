...
CREATE TABLE `customers` (
  ...
  `shipping_addres` varchar(100) DEFAULT NULL,
...
CREATE TABLE `sells` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `bills_id_idx` (`bill_id`),
  KEY `product_id_idx` (`product_id`),
  CONSTRAINT `bill_id` FOREIGN KEY (`bill_id`) REFERENCES `bills` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2021-02-09 13:05:25
